...
namespace Vector3
{
	...
	{
		XMVECTOR lhs = XMLoadFloat3(&xmf3Vector1);
		XMVECTOR rhs = XMLoadFloat3(&xmf3Vector2);
	...
	{
		XMMATRIX rhs = XMLoadFloat4x4(&xmmtx4x4Matrix);

		return(TransformCoord(xmf3Vector, rhs));
